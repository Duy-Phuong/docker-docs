...
https://www.linode.com/docs/guides/what-is-docker/
...
1. To add the EPEL repository, install the latest [epel-release package](https://download.fedoraproject.org/pub/epel/6/i386/repoview/epel-release.html).
...
Running a program like `echo` in a Docker container is pretty simple. However, for programs that act as servers, such as [Nginx](https://nginx.com/), you will need to ensure that the program is configured not to self-daemonize.
...
By default, Docker containers do not have persistent storage. In order to share data between containers, use the [VOLUME](https://docs.docker.com/en/latest/use/working_with_volumes/) feature:
...
- [Docker’s Getting Started guide](https://www.docker.io/gettingstarted/)
